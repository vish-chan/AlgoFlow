# <picture> <source media="(prefers-color-scheme: dark)" srcset="apps/web/frontend/public/logo-dark.svg"><img alt="AlgoFlow Logo" src="apps/web/frontend/public/favicon.svg" width="32" height="32" style="vertical-align: middle;"> </picture> AlgoFlow
